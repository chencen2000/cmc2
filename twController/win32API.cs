...
namespace twController
{
    class win32API
    {
        ...
        public static extern IntPtr SetupDiCreateDeviceInfoList(IntPtr guid, IntPtr hwnd);
        ...
        [DllImport("Setupapi.dll", CharSet = CharSet.Auto, SetLastError = true)]
        public static extern bool SetupDiOpenDeviceInfo(IntPtr lpInfoSet, string instanceId, IntPtr hwnd, uint flags, ref SP_DEVINFO_DATA devInfoData);
        [DllImport("Setupapi.dll", CharSet = CharSet.Auto, SetLastError = true)]
        public static extern bool SetupDiOpenDeviceInterface(IntPtr lpInfoSet, string devicePath, IntPtr hwnd, uint flags, ref SP_DEVICE_INTERFACE_DATA devInterfaceData);
        [DllImport("Setupapi.dll", CharSet = CharSet.Auto, SetLastError = true)]
        public static extern bool SetupDiCreateDeviceInterface(IntPtr lpInfoSet, ref SP_DEVINFO_DATA devInfoData, ref System.Guid guid, string ReferenceString, uint flags, ref SP_DEVICE_INTERFACE_DATA devInterfaceData);
        ...
        [DllImport("setupapi.dll", SetLastError = true)]
        public static extern int CM_Get_Child(out UInt32 pdnDevInst, UInt32 dnDevInst, int ulFlags);
        [DllImport("setupapi.dll", SetLastError = true)]
        public static extern int CM_Get_Sibling(out UInt32 pdnDevInst, UInt32 dnDevInst, int ulFlags);
        [DllImport("setupapi.dll", CharSet = CharSet.Auto)]
        ...
        [DllImport("winusb.dll", SetLastError = true)]
        public static extern Boolean WinUsb_Initialize(IntPtr DeviceHandle, ref IntPtr InterfaceHandle);
        ...
        [DllImport("winusb.dll", SetLastError = true)]
        public static extern Boolean WinUsb_ResetPipe(IntPtr InterfaceHandle, Byte PipeID);
        #endregion
        #endregion
    }
}
